...
/// <summary>
/// 邮政分揽投机构API配置实体（单例模式）
/// Postal Collection API configuration entity (Singleton pattern)
/// </summary>
/// <remarks>
...
/// </remarks>
public record class PostCollectionConfig
{
    /// <summary>
    /// 单例配置ID（固定为"PostCollectionConfigId"）
    /// Singleton configuration ID (Fixed as "PostCollectionConfigId")
    /// </summary>
    public const string SingletonId = "PostCollectionConfigId";
