        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ...
                    TargetChute = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ActualChute = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    DecisionReason = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    MatchedRuleId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    PositionBias = table.Column<int>(type: "INTEGER", nullable: false),
                    ChuteNumber = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    BagId = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
