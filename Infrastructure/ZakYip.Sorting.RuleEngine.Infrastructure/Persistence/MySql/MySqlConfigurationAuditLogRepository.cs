...
/// </summary>
public class MySqlConfigurationAuditLogRepository : IConfigurationAuditLogRepository
{
    private readonly MySqlLogDbContext _context;

    public MySqlConfigurationAuditLogRepository(MySqlLogDbContext context)
    {
        _context = context;
    }
